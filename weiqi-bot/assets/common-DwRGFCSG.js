const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./JosekiThumbnail-B3x2-Ze4.js","./WebDebugAdapter-KMyHb1JZ.js","./Bootstrap-DrRjQOqK.js","./CaptureRule-DpdjOT66.js","./IPlayer-BMtOWMYN.js"])))=>i.map(i=>d[i]);
import{d as e,l as t,u as n}from"./WebDebugAdapter-KMyHb1JZ.js";import{t as r}from"./GameResult-C_75ZNuC.js";import{t as i}from"./adapters-C0_w9z3J.js";import{r as a}from"./JosekiThumbnail-B3x2-Ze4.js";e();var o=class{get title(){return this._title}constructor(e){n(this,`_title`,`棋谱列表`),n(this,`readMarkService`,void 0),n(this,`category`,void 0),n(this,`providers`,void 0),n(this,`gameService`,void 0),n(this,`gameHistoryStorage`,void 0),n(this,`card`,void 0),n(this,`toast`,void 0),n(this,`games`,[]),n(this,`readMarkIds`,[]),n(this,`currentUserId`,void 0),n(this,`onNavigate`,void 0),n(this,`onClearReadMarks`,void 0),n(this,`customItemClick`,void 0),n(this,`initialized`,!1),this.readMarkService=e.readMarkService,this.category=e.category,this.providers=e.providers,this.gameService=e.gameService,this.gameHistoryStorage=e.gameHistoryStorage,this.onNavigate=e.onNavigate,this.onClearReadMarks=e.onClearReadMarks,this.customItemClick=e.onItemClick,this.card=i.createCard(),this.toast=i.createToast()}async initialize(){var e=this;e.initialized||(e.initialized=!0)}handleParams(e){if(e.gamesJson)try{this.games=JSON.parse(e.gamesJson)}catch(e){console.warn(`解析棋谱数据失败`),this.games=[]}e.title&&(this._title=e.title),e.userId&&(this.currentUserId=e.userId),this.loadReadMarks(),this.render()}async loadGames(e,t,n){var r=this;r.currentUserId=n;let i=r.providers.get(e);if(!i){console.error(`未找到 category="${e}" 的棋谱列表提供者`),r.toast.error(`未找到数据提供者`),r.games=[],r.render();return}try{let e=await i.getGameArchiveIds(t),n=[];for(let t of e)if(r.gameHistoryStorage){let e=await r.gameHistoryStorage.findById(t);if(e&&e.metadata){let r=e.metadata.result||void 0,i=e.metadata.blackName||e.metadata.black||``,a=e.metadata.whiteName||e.metadata.white||``;n.push({id:t,archiveId:t,black:i,white:a,date:e.metadata.date||``,...r?{result:r}:{}})}}else{let e=t.split(`-`).slice(1).join(`-`)||t;n.push({id:e,archiveId:t,black:`-`,white:`-`,date:`-`})}r.games=n,r.loadReadMarks(),r.render()}catch(e){console.error(`加载棋谱数据失败`,e),r.toast.error(`加载失败`),r.games=[],r.render()}}setData(e){this.games=e,this.loadReadMarks(),this.render()}async loadReadMarks(){var e=this;e.readMarkIds=await e.readMarkService.getReadMarks(e.category)}async clearReadMarks(){var e=this,t;await e.readMarkService.clearReadMarks(e.category),e.readMarkIds=[],(t=e.onClearReadMarks)==null||t.call(e),e.render()}async onItemClick(e){var t=this;let n=t.games.find(t=>t.id===e);n&&(await t.readMarkService.markRead(t.category,e),t.readMarkIds.push(e),!(t.customItemClick&&t.customItemClick(n)!==!1)&&n.archiveId&&t.onNavigate&&t.onNavigate(`replay`,{archiveId:n.archiveId}))}render(){let e=document.getElementById(`page-root`);if(!e)return;let t=`📋 共 ${this.games.length} 局，已读 ${this.games.filter(e=>this.readMarkIds.includes(e.id)).length} 局`,n=`<div class="source-header-controls">
      ...
      <div class="source-group">
        ...
        <div class="game-list">
          ${this.games.map((e,t)=>{let n=this.readMarkIds.includes(e.id),i=e.black===this.currentUserId,a=e.white===this.currentUserId,o=r(e.result),s=``;return o.includes(`黑`)?s=i?`result-win`:`result-lose`:o.includes(`白`)&&(s=a?`result-win`:`result-lose`),`
        <div class="game-card-wrapper ${n?`viewed`:``}" data-index="${t}" data-id="${e.id}">
          <div class="game-card">
    ...
    `,e.querySelectorAll(`.game-card-wrapper`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.id;t&&this.onItemClick(t)})}),this.bindClearBtn()}bindClearBtn(){let e=document.getElementById(`clearReadBtn`);e&&(e.onclick=()=>this.clearReadMarks())}destroy(){this.card.destroy(),this.toast.destroy(),this.games=[],this.readMarkIds=[],this.initialized=!1}};e();var s=class{constructor(){n(this,`currentFilter`,`all`)}getPatternTags(e){let t=[];return e.prefixLen>=8&&e.frequency>=5&&t.push(`hot`),e.prefixLen>=8&&e.prefixLen>=e.totalMoves&&t.push(`hit`),e.prefixLen>=12&&t.push(`complex`),t}setFilter(e){this.currentFilter=e}getFilter(){return this.currentFilter}filterPatterns(e){return e.filter(e=>this.currentFilter===`all`?!0:this.getPatternTags(e).includes(this.currentFilter))}getCounts(e){return{all:e.length,hot:e.filter(e=>this.getPatternTags(e).includes(`hot`)).length,hit:e.filter(e=>this.getPatternTags(e).includes(`hit`)).length,complex:e.filter(e=>this.getPatternTags(e).includes(`complex`)).length}}};e();var c=class{constructor(e){n(this,`readMarkService`,void 0),n(this,`readMarkIds`,[]),n(this,`currentCategory`,void 0),this.readMarkService=e}setCategory(e){this.currentCategory=e}async loadReadMarks(){var e=this;e.currentCategory&&(e.readMarkIds=await e.readMarkService.getReadMarks(e.currentCategory))}async markRead(e){var t=this;t.currentCategory&&(await t.readMarkService.markRead(t.currentCategory,e),t.readMarkIds.includes(e)||t.readMarkIds.push(e))}async clearReadMarks(){var e=this;e.currentCategory&&(await e.readMarkService.clearReadMarks(e.currentCategory),e.readMarkIds=[])}isRead(e){return this.readMarkIds.includes(e)}getReadMarkIds(){return this.readMarkIds}reset(){this.readMarkIds=[],this.currentCategory=void 0}},l=class{showWinrateDetail(e){if(!(e!=null&&e.delta))return;let t=e.delta,n=`<div class="winrate-detail-row"><span class="winrate-detail-label">胜率变化</span><span class="winrate-detail-value">`+(t>0?`+`:``)+(t*100).toFixed(2)+`%</span></div>`;if(e.stddev!==void 0){let t=e.stddev,r=`较稳定`;r=t<.02?`很稳定`:t<.04?`较稳定`:t<.06?`一般`:`不稳定`,n+=`<div class="winrate-detail-row"><span class="winrate-detail-label">标准差</span><span class="winrate-detail-value">`+t.toFixed(4)+` (`+r+`)</span></div>`}if(e.samples!==void 0){let t=e.samples,r=e.positive||0,i=e.negative||0,a=e.neutral||0,o=t>0?Math.round(r/t*100):0,s=t>0?Math.round(i/t*100):0,c=t>0?Math.round(a/t*100):0;n+=`<div class="winrate-detail-row"><span class="winrate-detail-label">样本数</span><span class="winrate-detail-value">`+t+`</span></div>`,n+=`<div class="winrate-bar"><div class="winrate-bar-positive" style="width:`+o+`%"></div><div class="winrate-bar-neutral" style="width:`+c+`%"></div><div class="winrate-bar-negative" style="width:`+s+`%"></div></div>`,n+=`<div class="winrate-bar-labels"><span>黑有利 `+r+` (`+o+`%)</span><span>中性 `+a+`</span><span>白有利 `+i+` (`+s+`%)</span></div>`}n+=`<div class="winrate-hint">💡 delta > 0: 先手有利</div>`;let r=document.getElementById(`winrate-content`);r&&(r.innerHTML=n);let i=document.getElementById(`winrate-backdrop`),a=document.getElementById(`winrate-sheet`);i&&i.classList.add(`active`),a&&a.classList.add(`active`)}formatWinrate(e){return e===void 0?{display:`-`,className:`neutral`}:{display:(e>0?`+`:``)+(e*100).toFixed(1)+`%`,className:e>.01?`positive`:e<-.01?`negative`:`neutral`}}};e();var u=class{constructor(e){n(this,`config`,void 0),this.config=e}renderFilterTabs(e,t){let n=document.getElementById(`filter-tabs`);if(!n)return;let r=this.config.filterManager.getCounts(e);n.innerHTML=[{id:`all`,label:`全部`,count:r.all},{id:`hot`,label:`🔥热门`,count:r.hot},{id:`hit`,label:`🎯命中`,count:r.hit},{id:`complex`,label:`🧩复杂`,count:r.complex}].map(e=>`
