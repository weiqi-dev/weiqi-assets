import{l as e}from"../FavoriteService-CuLiD-pB.js";import"../modulepreload-polyfill-Btlm8H0F.js";/* empty css               */import{d as t,n,t as r}from"../Bootstrap-zbz5vrIV.js";import{t as i}from"../game-Bhy-ql8Z.js";import{l as a,u as o}from"../IPlayer-CgO1tktP.js";import{n as s,t as c}from"../WebFileExporter-6LTyjd7X.js";var l=class{constructor(){e(this,`qrInstances`,new WeakMap)}async generate(e,t,n){var r=this,i,a,o,s;let c=await r.loadQRCodeLib();if(!c)throw Error(`QRCode library not available`);r.clear(e);let l=new c(e,{width:(i=n==null?void 0:n.width)==null?200:i,height:(a=n==null?void 0:n.height)==null?200:a,colorDark:(o=n==null?void 0:n.colorDark)==null?`#000000`:o,colorLight:(s=n==null?void 0:n.colorLight)==null?`#ffffff`:s});l.makeCode(t),r.qrInstances.set(e,l)}clear(e){e.innerHTML=``,this.qrInstances.delete(e)}isAvailable(){return typeof window<`u`}async loadQRCodeLib(){return typeof window>`u`?null:window.QRCode?window.QRCode:new Promise(e=>{let t=document.createElement(`script`);t.src=`https://cdn.jsdelivr.net/npm/qrcodejs@1.0.0/qrcode.min.js`,t.onload=()=>e(window.QRCode||null),t.onerror=()=>e(null),document.head.appendChild(t)})}},u=class{constructor(t){var n;e(this,`modalId`,`qr-dialog-${Date.now()}`),e(this,`containerId`,`qr-container-${Date.now()}`),e(this,`config`,void 0),e(this,`qrGenerator`,void 0),this.config=t==null?{title:`扫码分享`,hint:`截图或长按二维码识别`}:t,this.qrGenerator=(n=t==null?void 0:t.qrGenerator)==null?new l:n}async show(e){var t=this;t.createDialog();let n=document.getElementById(t.containerId);if(n)try{await t.qrGenerator.generate(n,e,{width:200,height:200,colorDark:`#333`,colorLight:`#fff`})}catch(e){n.innerHTML=`<div style="color:#c53030; font-size:13px;">二维码生成失败</div>`}let r=document.getElementById(t.modalId);r&&(r.style.display=`flex`)}hide(){let e=document.getElementById(this.modalId);e&&(e.style.display=`none`,e.remove())}destroy(){this.hide()}createDialog(){let e=document.getElementById(this.modalId);e&&e.remove();let t=document.createElement(`div`);t.id=this.modalId,t.innerHTML=this.renderHTML(),document.body.appendChild(t),t.addEventListener(`click`,e=>{e.target===t&&this.hide()}),t.addEventListener(`click`,e=>{e.target.closest(`[data-action="close-qr"]`)&&this.hide()})}renderHTML(){return`
      <div style="
        position: fixed;
        top: 0;
        left: 0;
...
`))}this.bookmarkCard.render()}async showQRCodeDialog(e){var t=this;e.success&&e.shareUrl&&await t.qrDialog.show(e.shareUrl)}render(){this.tabs.render(),this.queryPanel.render(),this.bookmarkPanel.render(),this.resultCard.render()}destroy(){this.tabs.destroy(),this.queryPanel.destroy(),this.bookmarkPanel.destroy(),this.resultCard.destroy(),this.toast.destroy(),this.overlay.destroy(),this.qrDialog.destroy(),this.hasResult=!1,this._currentResult=void 0}};function f(e){if(!e)return`-`;let t={"B+R":`黑中盘胜`,"W+R":`白中盘胜`,"B+T":`黑超时胜`,"W+T":`白超时胜`};if(t[e])return t[e];let n=e.match(/^([BW])\+([\d.]+)$/);return n?`${n[1]===`B`?`黑`:`白`}胜${n[2]}目`:e}var p=class{constructor(t){var n;e(this,`locale`,void 0),this.locale=(n=t==null?void 0:t.locale)==null?`zh-CN`:n}formatLoading(e){return`
    ...
    `}formatResultInfo(e){let t=e.metadata.black||`未知`,n=e.metadata.white||`未知`;e.metadata.date;let r=e.metadata.movesCount||0,i=f(e.metadata.result);return`
    ...
    `}formatBookmarkItem(e){let t=e.black||`未知`,n=e.white||`未知`,r=f(e.result),i=this.formatSource(e.source),a=e.date||`未知时间`,o=e.movesCount||0;return`
      <div data-action="viewBookmark" data-id="${e.id}" style="padding:10px 0; border-top:1px solid #eee; cursor:pointer;" onmouseover="this.style.background='#f8f9fa'" onmouseout="this.style.background=''">
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:6px;">
          ...
          <span style="font-size:0.8em; color:#888;">${a}</span>
        </div>
