import"../modulepreload-polyfill-BVSDYCMZ.js";/* empty css               */import{i as e,m as t,t as n}from"../Bootstrap-tBX0Q8OR.js";import{o as r}from"../FavoriteService-D-_Lo8Jb.js";import{t as i}from"../game-BWXHISnQ.js";import{t as a}from"../GameResult-CHgh2I9i.js";import{n as o,r as s}from"../SGFParser-DornNV6H.js";import{n as c,t as l}from"../WebFileExporter-klFndVPG.js";var u=class{constructor(){r(this,`qrInstances`,new WeakMap)}async generate(e,t,n){var r=this,i,a,o,s;let c=await r.loadQRCodeLib();if(!c)throw Error(`QRCode library not available`);r.clear(e);let l=new c(e,{width:(i=n==null?void 0:n.width)==null?200:i,height:(a=n==null?void 0:n.height)==null?200:a,colorDark:(o=n==null?void 0:n.colorDark)==null?`#000000`:o,colorLight:(s=n==null?void 0:n.colorLight)==null?`#ffffff`:s});l.makeCode(t),r.qrInstances.set(e,l)}clear(e){e.innerHTML=``,this.qrInstances.delete(e)}isAvailable(){return typeof window<`u`}async loadQRCodeLib(){return typeof window>`u`?null:window.QRCode?window.QRCode:new Promise(e=>{let t=document.createElement(`script`);t.src=`https://cdn.jsdelivr.net/npm/qrcodejs@1.0.0/qrcode.min.js`,t.onload=()=>e(window.QRCode||null),t.onerror=()=>e(null),document.head.appendChild(t)})}},d=class{constructor(e){var t;r(this,`modalId`,`qr-dialog-${Date.now()}`),r(this,`containerId`,`qr-container-${Date.now()}`),r(this,`config`,void 0),r(this,`qrGenerator`,void 0),this.config=e==null?{title:`扫码分享`,hint:`截图或长按二维码识别`}:e,this.qrGenerator=(t=e==null?void 0:e.qrGenerator)==null?new u:t}async show(e){var t=this;t.createDialog();let n=document.getElementById(t.containerId);if(n)try{await t.qrGenerator.generate(n,e,{width:200,height:200,colorDark:`#333`,colorLight:`#fff`})}catch(e){n.innerHTML=`<div style="color:#c53030; font-size:13px;">二维码生成失败</div>`}let r=document.getElementById(t.modalId);r&&(r.style.display=`flex`)}hide(){let e=document.getElementById(this.modalId);e&&(e.style.display=`none`,e.remove())}destroy(){this.hide()}createDialog(){let e=document.getElementById(this.modalId);e&&e.remove();let t=document.createElement(`div`);t.id=this.modalId,t.innerHTML=this.renderHTML(),document.body.appendChild(t),t.addEventListener(`click`,e=>{e.target===t&&this.hide()}),t.addEventListener(`click`,e=>{e.target.closest(`[data-action="close-qr"]`)&&this.hide()})}renderHTML(){return`
      <div style="
        position: fixed;
        top: 0;
        left: 0;
