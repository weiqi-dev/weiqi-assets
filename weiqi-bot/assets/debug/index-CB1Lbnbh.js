import"../modulepreload-polyfill-eJgYjmQ8.js";/* empty css               */import{t as e}from"../Bootstrap-DrRjQOqK.js";import{t}from"../Dialog-Dn-0dzuF.js";import{t as n}from"../WebFileExporter-DHltGeEQ.js";/* empty css            */import{t as r}from"../DebugService-hChygO6y.js";async function i(){await e.init({containerId:`page-root`}),await a(new r),console.info(`日志页面已启动`)}async function a(e,n){var r,i,l,u;let f=document.getElementById(`page-root`);if(!f)return;let p=await e.getLogs({limit:200}),m=await e.getLogStats(),h=o(p,n);f.innerHTML=`
    <div class="log-panel">
